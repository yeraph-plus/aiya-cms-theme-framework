...
aya_add_plugin_opt(
    [
        'desc' => __('图片处理器配置', 'aiya-framework'),
        'type' => 'title_2',
    ],
    [
        'title' => __('接管媒体库', 'aiya-framework'),
        'desc' => __('使用主题提供的图片处理器接管 WordPress 默认的图片处理功能', 'aiya-framework'),
        'id' => 'site_plugin_image_handle_wp_bool',
        'type' => 'switch',
        'default' => true,
    ],
    [
        'desc' => __('注意：如果你的 PHP 环境没有安装 libwebp 库或 libavif 库，无法使用对应格式保存图片', 'aiya-framework'),
        'type' => 'warning',
    ],
    [
        'title' => __('使用格式转换', 'aiya-framework'),
        'desc' => __('使用 WebP 或 AVIF 格式保存图片，提高加载速度', 'aiya-framework'),
    ...
    [
        ...
        'desc' => __('图片上传的最大宽度，超过宽度会被缩放，设置为 0 则不限制', 'aiya-framework'),
        'id' => 'site_plugin_image_max_width',
        'type' => 'number',
        'default' => '0',
    ],
    [
        'title' => __('图片保存质量', 'aiya-framework'),
        'desc' => __('图片保存时的质量，范围 0-100', 'aiya-framework'),
    ...
    [
        ...
        'type' => 'radio',
        'sub' => [
            'off' => __('禁用', 'aiya-framework'),
            'image' => __('图片', 'aiya-framework'),
            'text' => __('文本', 'aiya-framework'),
        ],
        'default' => 'off',
    ],
    [
        'title' => __('水印位置', 'aiya-framework'),
        'desc' => __('水印在图片上的位置', 'aiya-framework'),
        'id' => 'site_plugin_image_watermark_position',
        'type' => 'select',
        'sub' => [
            'center-center' => __('居中', 'aiya-framework'),
            'center-left' => __('居中左侧', 'aiya-framework'),
            'center-right' => __('居中右侧', 'aiya-framework'),
            'center-top' => __('居中顶部', 'aiya-framework'),
            'center-bottom' => __('居中底部', 'aiya-framework'),
            'top-right' => __('顶部右侧', 'aiya-framework'),
            'top-left' => __('顶部左侧', 'aiya-framework'),
            'top-center' => __('顶部居中', 'aiya-framework'),
            'bottom-right' => __('底部右侧', 'aiya-framework'),
            'bottom-left' => __('底部左侧', 'aiya-framework'),
            'bottom-center' => __('底部居中', 'aiya-framework'),
        ],
    ...
    [
        ...
        'desc' => __('水印字体的大小', 'aiya-framework'),
        'id' => 'site_plugin_image_watermark_font_size',
        'type' => 'number',
        'default' => '24',
    ],
    [
        'title' => __('水印透明度', 'aiya-framework'),
        'desc' => __('水印的透明度，范围 0-100，100 表示完全透明，0 表示完全不透明', 'aiya-framework'),
...
function aya_image_manager_handle_wp_upload(array $upload, string $context): array
{
    ...
    if (!is_string($new_file) || $new_file === '' || !is_file($new_file)) {
        return ['error' => __('图片处理失败，已取消上传', 'aiya-framework')];
    }
